...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Initiate a fund transfer' }),
...
__decorate([
    (0, common_1.Get)('history/:accountId'),
    (0, swagger_1.ApiOperation)({ summary: 'Get transaction history for a specific account' }),
    __param(0, (0, common_1.Request)()),
